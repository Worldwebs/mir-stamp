    ...
    <?php if ($options) { ?>
      ...
      <?php if ($option['type'] == 'date') { ?>
        ...
        <div class="form-group">
          ...
          <br />
          <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button button-color2 button-type2"><?php echo $button_cart; ?></button>
        </div>
        <?php if ($minimum > 1) { ?>
     ...
     if (json['error']['recurring']) {
       $('select[name=\'recurring_id\']').after('<div class="text-danger">' + json['error']['recurring'] + '</div>');
			...
			if (json['success']) {
				...
				$('.produt-in-cart').load('index.php?route=common/cart/info .produt-in-cart-item');
